...
and use it with AECP.
"""

from typing import List
from aecp import AECP, register_adapter, adapter
...
def example_manual_registration():
    ...
    agent = AECP(adapter, agent_id="custom_agent")
...
def example_decorator_usage():
    ...
    agent = AECP(adapter, agent_id="another_agent")
...
def example_calibration_with_custom():
    ...
    agent1 = AECP(custom_adapter, agent_id="custom_agent")
    agent2 = AECP(mock_adapter, agent_id="mock_agent")

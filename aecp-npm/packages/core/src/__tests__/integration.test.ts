/**
 * AECP Integration Tests with Real Embedding Models
 * 
...
describe.skip('AECP Integration Tests (requires API keys)', () => {
  describe('OpenAI Embeddings', () => {
    test('should calibrate between OpenAI small and large models', async () => {
      // This test would require @aecp/adapters-openai
      // 
 ...
 *    npm install @aecp/core @aecp/adapters-openai @aecp/adapters-voyage
 * 

...
- Initial release of AECP protocol implementation
- `AECP` class for agent communication
...
#### Adapters
- **@aecp/adapters-openai**: OpenAI embeddings support
  - text-embedding-3-small (1536D)
  - text-embedding-3-large (3072D)
  - text-embedding-ada-002 (1536D)

- **@aecp/adapters-voyage**: Voyage AI embeddings support
  - voyage-2 (1024D)
  - voyage-large-2 (1536D)
  - voyage-code-2 (1536D)

- **@aecp/adapters-cohere**: Cohere embeddings support
  - embed-english-v3.0 (1024D)
  - embed-multilingual-v3.0 (1024D)
  - embed-english-light-v3.0 (384D)
  - embed-multilingual-light-v3.0 (384D)

- **@aecp/adapters-huggingface**: Local inference support
...
Based on research validating Agent Embedding Communication Protocol (AECP):

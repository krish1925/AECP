...
**Parameters:**
- `otherAgent: AECP` - Target agent for calibration
...
```typescript
import { cosineSimilarity, computeTransferMatrices } from '@aecp/core';
```
...
```typescript
import { DEFAULT_VOCABULARY, generateExtendedVocabulary } from '@aecp/core';
```

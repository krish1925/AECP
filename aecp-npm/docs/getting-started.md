# Getting Started with AECP

## What is AECP?

The Agent Embedding Communication Protocol (AECP) enables agents with different embedding models to communicate semantic information directly, achieving **2x better semantic preservation** compared to text serialization.
...
- GitHub Issues: [github.com/your-org/aecp](https://github.com/your-org/aecp)
- Documentation: [aecp.dev](https://aecp.dev)

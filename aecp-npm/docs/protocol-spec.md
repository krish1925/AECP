# AECP Protocol Specification v1.0

## Overview

The Agent Embedding Communication Protocol (AECP) enables semantic communication between agents using different embedding models through learned linear transfer matrices.
